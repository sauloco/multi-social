<template>
  <div>
    ...
    <p>
      At Multi-Social, accessible from https://multisocial.netlify.app, one of
      ...
      Multi-Social and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Multi-Social. This policy is not applicable to any
    ...
    <h2>Log Files</h2>
    <p>
      Multi-Social follows a standard procedure of using log files. These files
    ...
    <p>
      Like any other website, Multi-Social uses 'cookies'. These cookies are
    ...
    <p>
      ...
      advertising partners of Multi-Social.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Multi-Social, which are sent
    ...
    <p>
      Note that Multi-Social has no access to or control over these cookies that
      are used by third-party advertisers.
    </p>

    Third Party Privacy Policies
    <p>
      Multi-Social's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Multi-Social does not knowingly collect any Personal Identifiable
